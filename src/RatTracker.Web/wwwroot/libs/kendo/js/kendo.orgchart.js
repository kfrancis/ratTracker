...
/***/ (function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function(f, define){
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(1360), __webpack_require__(1361), __webpack_require__(1111), __webpack_require__(1260), __webpack_require__(1362), __webpack_require__(1252), __webpack_require__(1209) ], __WEBPACK_AMD_DEFINE_FACTORY__ = (f), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	})(function(){
	...
	(function ($, undefined) {
	    ...
	    var AVATAR_PREVIEW_TEMPLATE = '<div class="k-orgchart-avatar-preview k-hstack k-align-items-center k-pb-lg">' +
	        '<div class="k-avatar-circle k-avatar k-avatar-lg">' +
	            '<div class="k-avatar-image">' +
	                '<img src="#: avatar #" alt="#: name #">' +
	            '</div>' +
	        '</div>' +
	        '<div class="k-px-md">#: fileName #</div>' +
	        '<button class="k-button k-flat k-button-icon" aria-label="#: destroy #">' +
	            '<span class="k-icon k-i-delete"></span>' +
	        '</button>' +
	    '</div>';

	    var EDITOR_BUTTONS_TEMPLATE = '<div class="k-edit-buttons k-state-default">' +
	        '<button type="button" class="k-button k-orgchart-cancel">' +
	            '<span class="k-button-text">#: cancel #</span>' +
	        '</button>' +
	        '<button type="button" class="k-button k-primary k-orgchart-update">' +
