...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function($, undefined) {
	    ...
	    var BUTTON_TEMPLATE = '<button aria-label="#: label #" tabindex="-1" class="k-orgchart-button k-button k-button-icon">' +
	            '<span class="k-icon k-i-#: buttonSign #"></span>' +
	    '</button>';

	    var CARD_TEMPLATE = '<div class="k-card-body k-hstack" style="border-color:#: color #">' +
	        '# if(!!data.avatar) { #' +
	            '<div class="k-avatar-circle k-avatar k-avatar-md">' +
	        ...
	        '# if(editable) { #' +
	            ...
	            '<div class="k-card-body-actions">' +
	                '<button class="k-button k-flat k-button-icon k-orgchart-card-menu" role="button" aria-label="#: menuLabel #" tabindex="-1">' +
