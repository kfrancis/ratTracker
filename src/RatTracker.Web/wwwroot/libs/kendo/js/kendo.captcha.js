	    ...
	    (function ($, undefined) {
	        ...
	        var Captcha = Widget.extend({
	            ...
	            _resetButton: function () {
	                ...
	                that.resetButton = $("<button type=\"button\" title=\"" + messages.reset + "\" class=\"" + styles.button + " " + styles.buttonIcon + "\">" +
	            ...
	            _audioButton: function () {
	                ...
	                that.audioButton = $("<button type=\"button\" title=\"" + messages.audio + "\" class=\"" + styles.button + " " + styles.buttonIcon + "\">" +
