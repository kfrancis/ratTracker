	...
	(function($, undefined) {
	    ...
	    var SingleSelection = kendo.Class.extend({
	        ...
	        _span: function() {
	            ...
	            if (!span[0]) {
	                wrapper.append('<span unselectable="on" class="k-dropdown-wrap k-state-default"><span unselectable="on" class="k-input">&nbsp;</span><span role="button" unselectable="on" class="k-select" aria-label="select"><span class="k-icon k-i-arrow-60-down"></span></span></span>')
	            ...
	            dropdowntree.valueTemplate = function(data) {
	                if (isMultiple) {
	                    ...
	                    '>' +
	                        ...
	                        '<span aria-hidden="true" title="' + dropdowntree.options.messages.deleteTag + '" aria-label="' + dropdowntree.options.messages.deleteTag + '" class="k-select">' +
