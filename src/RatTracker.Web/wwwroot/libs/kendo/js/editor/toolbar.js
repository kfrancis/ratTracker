...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function($,undefined) {
	    ...
	    var focusable = ".k-tool-group:visible .k-tool:not(.k-state-disabled):not([disabled])," +
	    ...
	    var Toolbar = Widget.extend({
	        ...
	        attachToolsEvents: function(element) {
	            var that = this,
	                ...
	                enabledButtons = buttons + ":not(.k-state-disabled)" + ", [role=button].k-i-import:not(.k-state-disabled)",
