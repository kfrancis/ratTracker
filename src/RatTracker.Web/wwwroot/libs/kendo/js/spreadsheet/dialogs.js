...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(1642);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function(kendo) {
	            ...
	            template:
	                "<div class='k-edit-form-container'>" +
	                    ...
	                    "<div class='k-action-buttons'>" +
	                        "<button class='k-button k-primary' data-#:ns#bind='click: apply'>#: messages.apply #</button>" +
	                        "<button class='k-button' data-#:ns#bind='click: close'>#: messages.cancel #</button>" +
	                    "</div>"+
	    ...
	    var MessageDialog = SpreadsheetDialog.extend({
	        options: {
	            ...
	            template:
	                ...
	                "<div class='k-action-buttons'>" +
	                    "<button class='k-button k-primary' data-#:ns#bind='click: close'>" +
	                        "#= messages.okText #" +
	                    "</button>" +
	                "</div>"
	        },
	    ...
	    var ConfirmationDialog = SpreadsheetDialog.extend({
	        ...
	        options: {
	            ...
	            template:
	                "<div class='k-spreadsheet-message-content' data-#:ns#bind='text: text'></div>" +
	                "<div class='k-action-buttons'>" +
	                    "<button class='k-button k-primary' data-#:ns#bind='click: confirm'>" +
	                        "#= messages.okText #" +
	                    "</button>" +
	                    "<button class='k-button' data-#:ns#bind='click: cancel'>" +
	                        "#= messages.cancel #" +
	                    "</button>" +
	                "</div>"
	        },
	    ...
	    var ValidationErrorDialog = SpreadsheetDialog.extend({
	        options: {
	            ...
	            "<div class='k-spreadsheet-message-content' data-#:ns#bind='text: text'></div>" +
	            "<div class='k-action-buttons'>" +
	            "<button class='k-button k-primary' data-#:ns#bind='click: retry'>" +
	                "#= messages.retry #" +
	            "</button>" +
	            "<button class='k-button' data-#:ns#bind='click: cancel'>" +
	                "#= messages.cancel #" +
	            ...
	            template:
	                '<div class="k-edit-form-container">' +
	                    ...
	                    '<div data-#:ns#bind="visible: isNumber">' +
	                        ...
	                        '<div class="k-edit-field">' +
	                            '<input name="#: messages.validationDialog.labels.min #" title="#: messages.validationDialog.labels.min #" placeholder="e.g. 10" class="k-textbox" data-#:ns#bind="value: from, enabled: isNumber" required="required" />' +
	                        '</div>' +
	                        '<div data-#:ns#bind="visible: showTo">' +
	                            '<div class="k-edit-label"><label>#: messages.validationDialog.labels.max #:</label></div>' +
	                            '<div class="k-edit-field">' +
	                                '<input name="#: messages.validationDialog.labels.max #" title="#: messages.validationDialog.labels.max #" placeholder="e.g. 100" class="k-textbox" data-#:ns#bind="value: to, enabled: showToForNumber" required="required" />' +
	                            '</div>' +
	                        '</div>' +
	                    '</div>' +
	                    ...
	                    '<div data-#:ns#bind="visible: isText">' +
	                        ...
	                        '<div class="k-edit-field">' +
	                            '<input name="#: messages.validationDialog.labels.value #" title="#: messages.validationDialog.labels.value #" class="k-textbox" data-#:ns#bind="value: from, enabled: isText" required="required" />' +
	                        '</div>' +
	                    '</div>' +
	                    ...
	                    '<div data-#:ns#bind="visible: isDate">' +
	                        ...
	                        '<div class="k-edit-field">' +
	                            '<input name="#: messages.validationDialog.labels.start #" title="#: messages.validationDialog.labels.start #" class="k-textbox" data-#:ns#bind="value: from, enabled: isDate" required="required" />' +
	                        '</div>' +
	                        '<div data-#:ns#bind="visible: showTo">' +
	                            '<div class="k-edit-label"><label>#: messages.validationDialog.labels.end #:</label></div>' +
	                            '<div class="k-edit-field">' +
	                                '<input name="#: messages.validationDialog.labels.end #" title="#: messages.validationDialog.labels.end #" class="k-textbox" data-#:ns#bind="value: to, enabled: showToForDate" required="required" />' +
	                            '</div>' +
	                        '</div>' +
	                    '</div>' +
	                    ...
	                    '<div data-#:ns#bind="visible: isCustom">' +
	                        '<div class="k-edit-label"><label>#: messages.validationDialog.labels.value #:</label></div>' +
	                        '<div class="k-edit-field">' +
	                            '<input name="#: messages.validationDialog.labels.value #" title="#: messages.validationDialog.labels.value #" class="k-textbox" data-#:ns#bind="value: from, enabled: isCustom" required="required" />' +
	                        '</div>' +
	                    '</div>' +
	                    ...
	                    '<div data-#:ns#bind="visible: isList">' +
	                        '<div class="k-edit-label"><label>#: messages.validationDialog.labels.value #:</label></div>' +
	                        '<div class="k-edit-field">' +
	                            '<input name="#: messages.validationDialog.labels.value #" title="#: messages.validationDialog.labels.value #" class="k-textbox" data-#:ns#bind="value: from, enabled: isList" required="required" />' +
	                        '</div>' +
	                    '</div>' +

	                    '<div data-#:ns#bind="visible: isList">' +
	                        '<div class="k-edit-field">' +
	                            '<input type="checkbox" name="showButton" id="listShowButton" class="k-checkbox" data-#:ns#bind="checked: showButton"/>' +
	                    ...
	                    '<div data-#:ns#bind="visible: isDate">' +
	                        '<div class="k-edit-field">' +
	                            '<input type="checkbox" name="showButton" id="dateShowButton" class="k-checkbox" data-#:ns#bind="checked: showButton"/>' +
	                    ...
	                    '<div data-#:ns#bind="invisible: isAny">' +
	                        '<div class="k-edit-field">' +
	                            '<input type="checkbox" title="#: messages.validationDialog.labels.ignoreBlank #" name="ignoreBlank" id="ignoreBlank" class="k-checkbox" data-#:ns#bind="checked: ignoreBlank"/>' +
	                    ...
	                    '<div data-#:ns#bind="invisible: isAny">' +
	                        ...
	                        '<div class="k-edit-field">' +
	                            '<input type="radio" title="#: messages.validationDialog.labels.rejectInput #" id="validationTypeReject" name="validationType" value="reject" data-#:ns#bind="checked: type" class="k-radio" />' +
	                            '<label for="validationTypeReject" class="k-radio-label">' +
	                                 "#: messages.validationDialog.labels.rejectInput #" +
	                            '</label> ' +
	                            '<input type="radio" title="#: messages.validationDialog.labels.showWarning #" id="validationTypeWarning"  name="validationType" value="warning" data-#:ns#bind="checked: type" class="k-radio" />' +
	                    ...
	                    '<div data-#:ns#bind="invisible: isAny" class="hint-wrapper">' +
	                        '<div class="k-edit-field">' +
	                            '<input type="checkbox" title="#: messages.validationDialog.labels.showHint #" name="useCustomMessages" id="useCustomMessages" class="k-checkbox" data-#:ns#bind="checked: useCustomMessages" />' +
	                        ...
	                        '<div data-#:ns#bind="visible: useCustomMessages">' +
	                            ...
	                            '<div class="k-edit-field">' +
	                                '<input class="k-textbox" title="#: messages.validationDialog.labels.hintTitle #" placeholder="#: messages.validationDialog.placeholders.typeTitle #" data-#:ns#bind="value: hintTitle" />' +
	                            '</div>' +
	                            '<div class="k-edit-label"><label>#: messages.validationDialog.labels.hintMessage #:</label></div>' +
	                            '<div class="k-edit-field">' +
	                                '<input class="k-textbox" title="#: messages.validationDialog.labels.hintMessage #" placeholder="#: messages.validationDialog.placeholders.typeMessage #" data-#:ns#bind="value: hintMessage" />' +
	                            '</div>' +
	                        '</div>' +
	                    '</div>' +

	                    '<div class="k-action-buttons">' +
	                        '<button class="k-button" data-#:ns#bind="visible: showRemove, click: remove">#: messages.remove #</button>' +
	                        '<button class="k-button k-primary" data-#:ns#bind="click: apply">#: messages.apply #</button>' +
	                        '<button class="k-button" data-#:ns#bind="click: close">#: messages.cancel #</button>' +
	                    "</div>" +
	                "</div>"
	    ...
	    var ExportAsDialog = SpreadsheetDialog.extend({
	        ...
	        options: {
	            ...
	            template:
	                ...
	                "<div class='k-edit-field'>" +
	                    "<input class='k-textbox' data-#:ns#bind='value: name' />" +
	                "</div>" +
	                "<div >" +
	                ...
	                "<div class='k-export-config' data-#:ns#bind='visible: showPdfOptions'>" +
	                    ...
	                    "<div class='k-edit-field'>" +
	                        "<input class='k-checkbox' id='guidelines' type='checkbox' data-#:ns#bind='checked: pdf.guidelines'/><label class='k-checkbox-label' for='guidelines'>#: messages.exportAsDialog.labels.guidelines#</label>" +
	                    "</div>" +
	                    "<div class='k-edit-label'><label>#: messages.exportAsDialog.labels.scale #:</label></div>" +
	                    "<div class='k-edit-field'>" +
	                        "<input class='k-checkbox' id='fitWidth' type='checkbox' data-#:ns#bind='checked: pdf.fitWidth'/><label class='k-checkbox-label' for='fitWidth'>#: messages.exportAsDialog.labels.fit #</label>" +
	                    "</div>" +
	                    "<div class='k-edit-label'><label>#: messages.exportAsDialog.labels.center #:</label></div>" +
	                    "<div class='k-edit-field'>" +
	                        "<input class='k-checkbox' id='hCenter' type='checkbox' data-#:ns#bind='checked: pdf.hCenter'/><label class='k-checkbox-label' for='hCenter'>#: messages.exportAsDialog.labels.horizontally #</label>" +
	                        "<input class='k-checkbox' id='vCenter' type='checkbox' data-#:ns#bind='checked: pdf.vCenter'/><label class='k-checkbox-label' for='vCenter'>#: messages.exportAsDialog.labels.vertically #</label>" +
	                    "</div>" +
	                ...
	                "</div>" +
	                "<div class='k-action-buttons'>" +
	                    "<button class='k-button k-primary' data-#:ns#bind='click: apply'>#: messages.save #</button>" +
	                    "<button class='k-button' data-#:ns#bind='click: close'>#: messages.cancel #</button>" +
	                "</div>"
	        },
	        apply: function() {
	    ...
	    var HyperlinkDialog = SpreadsheetDialog.extend({
	        options: {
	            ...
	            ("<div class='k-edit-label'><label>#: messages.linkDialog.labels.url #:</label></div>" +
	             "<div class='k-edit-field'><input class='k-textbox' data-#:ns#bind='value: url' title='#: messages.linkDialog.labels.url #' /></div>" +
	             "<div class='k-action-buttons'>" + (
	                 ("<button class='k-button k-left' data-#:ns#bind='click: remove'>#= messages.linkDialog.labels.removeLink #</button>" +
	                  "<button class='k-button k-primary' data-#:ns#bind='click: apply'>#= messages.okText #</button>" +
	                  "<button class='k-button' data-#:ns#bind='click: cancel'>#= messages.cancel #</button>")
	             ) + "</div>"
	            ),
	            autoFocus: false
	        },
	...
	<div class='k-edit-field'><textarea rows='5' class='k-textbox' data-#:ns#bind='value: comment'></textarea></div>\
	<div class='k-action-buttons'>\
	  <button class='k-button k-left' data-#:ns#bind='click: remove'>#: messages.insertCommentDialog.labels.removeComment #</button>\
	  <button class='k-button k-primary' data-#:ns#bind='click: apply'>#: messages.okText #</button>\
	  <button class='k-button' data-#:ns#bind='click: cancel'>#= messages.cancel #</button>\
	</div>\
	",
	...
	<div class='k-action-buttons'>\
	  <button class='k-button k-primary' data-#:ns#bind='enabled: okEnabled, click: apply'>#: messages.okText #</button>\
	  <button class='k-button' data-#:ns#bind='click: cancel'>#= messages.cancel #</button>\
	</div>",
