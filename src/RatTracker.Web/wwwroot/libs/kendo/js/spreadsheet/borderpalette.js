	    ...
	    (function(kendo) {
	        ...
	        var ColorChooser = kendo.ui.Widget.extend({
	                ...
	                var element = $("<div />", {
	                    ...
	                    "html": "<div></div>" +
	                            "<div class='k-action-buttons'>" +
	                                "<button class='k-button k-primary' data-" + kendo.ns + "bind='click: apply'>" + COLOR_PICKER_MESSAGES.apply + "</button>" +
	                                "<button class='k-button' data-" + kendo.ns + "bind='click: close'>" + COLOR_PICKER_MESSAGES.cancel + "</button>" +
	                            "</div>"
	                });
	            ...
	            _resetButton: function() {
	                this.resetButton = $("<a role='button' class='k-button k-reset-color' href='#'>" +
	                                    "<span class='k-icon k-i-reset-color'></span>" + COLOR_PICKER_MESSAGES.reset +
	                                   "</a>").appendTo(this.element);
	            },

	            _customColorButton: function() {
	                this.customColorButton = $("<a role='button' class='k-button k-custom-color' href='#'>" +
	        ...
	        var BorderPalette = kendo.ui.Widget.extend({
	            ...
	            _borderTypePalette: function() {
	                ...
	                var buttons = BORDER_TYPES.map(function(type) {
	                    return '<a role="button" title="' + messages[type] + '" aria-label="' + messages[type] + '" href="#" data-border-type="' + type + '" class="k-button k-button-icon">' +
