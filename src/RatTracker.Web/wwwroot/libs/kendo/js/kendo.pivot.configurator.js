...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function($, undefined) {
	    var kendo = window.kendo,
	        ...
	        SETTINGSTEMPLATE = kendo.template('<div class="k-pivotgrid-configurator-header">'+
	                                            '<div class="k-pivotgrid-configurator-header-text">#:title#</div>'+
	                                          '</div>'),
	        CONTENTTEMPLATE = kendo.template('<div class="k-pivotgrid-configurator-content">'+
	        ...
	        '</div>'),
	        TARGETITEMTEMPLATE =
	        '<div class="k-chip k-chip-has-icon k-chip-solid">'+
	            '<span class="k-chip-content">'+
	                '<span class="k-chip-label">#:name#</span>'+
	                '#if (menuenabled) {# <span class="k-icon k-i-more-vertical"></span> #}#'+
	            '</span>'+
	            '<span class="k-remove-icon">'+
	                '<span class="k-icon k-i-close-circle"></span>'+
	            '</span>'+
	        '</div>',
