...
/***/ (function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function(f, define){
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(1064), __webpack_require__(1269), __webpack_require__(1066), __webpack_require__(1209), __webpack_require__(1282), __webpack_require__(1396), __webpack_require__(1397), __webpack_require__(1398), __webpack_require__(1395), __webpack_require__(1399), __webpack_require__(1400), __webpack_require__(1401), __webpack_require__(1260), __webpack_require__(1296), __webpack_require__(1277), __webpack_require__(1272) ], __WEBPACK_AMD_DEFINE_FACTORY__ = (f), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	})(function(){
	...
	(function($, undefined) {
	    var kendo = window.kendo,
	            ...
	            '<div class="k-scheduler-toolbar k-toolbar">' +
	                ...
	                '# if (search) { #' +
	                    '<span class="k-scheduler-search k-textbox">' +
	                        '<input autocomplete="off" placeholder="${messages.search}" title="${messages.search}" class="k-input k-scheduler-search-input" />' +
	        ...
	        MOBILETOOLBARTEMPLATE = kendo.template('<div class="k-scheduler-toolbar k-toolbar">' +
	            ...
	            '# if (search) { #' +
	                '<span class="k-scheduler-search k-textbox">' +
	                    '<input autocomplete="off" placeholder="${messages.search}" title="${messages.search}" class="k-scheduler-search-input" />' +
	                    '<span class="k-input-icon"><span class="k-icon k-i-search"></span></span>' +
	                '</span>' +
	            '# } #' +
	            '#if(viewsCount === 1){#' +
