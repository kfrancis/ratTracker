	        ...
	        _updateHeader: function() {
	            ...
	            if (prevDisabled && nextDisabled) {
	                ...
	                if (!that._navContainer) {
	                    ...
	                    '<a href="#" role="button" class="k-button k-button-icon k-flat k-prev-view" ' + ARIA_LABEL + '="Previous"><span class="k-icon k-i-arrow-60-left"></span></a>' +
	                    '<a href="#" role="button" class="k-button k-button-icon k-flat k-next-view" ' + ARIA_LABEL + '="Next"><span class="k-icon k-i-arrow-60-right"></span></a>' +
	        ...
	        _header: function() {
	            ...
	            if (!header.length) {
	                header = $('<div class="k-calendar-header k-hstack">' +
	                    '<a href="#" role="button" class="k-calendar-title k-title k-button k-flat" aria-live="assertive" aria-atomic="true"></a>' +
	                    '<span class="k-spacer"></span>' +
	                    '<span class="k-calendar-nav k-hstack">' +
	                        '<a href="#" role="button" class="k-button k-flat k-button-icon k-prev-view" ' + ARIA_LABEL + '="Previous"><span class="k-icon k-i-arrow-60-left"></span></a>' +
	                        '<a href="#" role="button" class="k-button k-flat k-button-icon k-next-view" ' + ARIA_LABEL + '="Next"><span class="k-icon k-i-arrow-60-right"></span></a>' +
	                    '</span>' +
