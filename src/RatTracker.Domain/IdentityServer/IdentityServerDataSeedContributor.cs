...
namespace RatTracker.IdentityServer
{
    public class IdentityServerDataSeedContributor : IDataSeedContributor, ITransientDependency
    {
        ...
        private async Task CreateClientsAsync()
        {
            ...
            {
                var webClientRootUrl = configurationSection["RatTracker_App:RootUrl"]?.TrimEnd('/');
            ...
            {
                var swaggerRootUrl = configurationSection["RatTracker_Swagger:RootUrl"].TrimEnd('/');
