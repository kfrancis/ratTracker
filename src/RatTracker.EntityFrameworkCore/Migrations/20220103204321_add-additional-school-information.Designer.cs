...
{
    [DbContext(typeof(RatTrackerDbContext))]
    [Migration("20220103204321_add-additional-school-information")]
    partial class addadditionalschoolinformation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RatTracker.Results.Result", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.ToTable("AppResults", (string)null);
                });

            modelBuilder.Entity("RatTracker.Schools.School", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("SchoolFamily")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("AppSchools", (string)null);
                });
            ...
            modelBuilder.Entity("RatTracker.Results.Result", b =>
                {
                    b.HasOne("RatTracker.Schools.School", null)
                        .WithMany()
